...
# Insert new rows in studio table
new_studio = Studio.new
new_studio["name"] = "Warner Bros."
new_studio.save

# Insert new rows in movie table

# first query to find row in studio table
...
# Insert new rows in actor table
new_actor = Actor.new
...
new_actor = Actor.new
new_actor["name"] = "Maggie Gyllanhaal"
new_actor.save
...
# Insert new rows in role table

# first query to find rows in movie table
...
# then query to find row in actor table
...
gyllenhaal = Actor.find_by({ "name" => "Maggie Gyllanhaal" })
